...
sudo gzip     /home/pi/rpi/images/raspbian_basic_jessie_$(date +%Y%m%d).img
sudo mv       /home/pi/rpi/images/raspbian_basic_jessie_$(date +%Y%m%d).img.gz /home/pi/rpi/images/$(hostname)_raspbian_basic_jessie_$(date +%Y%m%d).img.gz
