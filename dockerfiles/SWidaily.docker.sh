...
echo "SWiface: end of day process using MariaDB." 	>>SWproc.docker.log
echo "=========================================="	>>SWproc.docker.log
echo "                   " 				>>SWproc.docker.log
date			 				>>SWproc.docker.log
echo "                   " 				>>SWproc.docker.log
...
echo "End of processes  MariaDB at server: "$hostname $(date) $HOSTNAME $city			>>SWproc.docker.log
echo "=========================================================================="		>>SWproc.docker.log
